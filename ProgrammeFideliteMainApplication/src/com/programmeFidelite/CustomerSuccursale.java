 ...
 * USAGE:
 * <pre>
 *        CustomerSuccursale client = new CustomerSuccursale();
...
public class CustomerSuccursale {
    ...
    public <T> T isSuccursaleMembre(Class<T> responseType, String id) throws ClientErrorException {
        WebTarget resource = webTarget;
